...
/* Define o nome e onde a classe LoginController está localizada. Namespaces ajudam a
   organizar o código e evitar conflitos de nomes. */
namespace ProjetoEcommerce.Controllers
{
    // Criando a classe LoginController e herdando  da classe
    public class UsuarioController : Controller
    {
        /* Declara uma variável privada somente leitura do tipo UsuarioRepositorio chamada _usuarioRepositorio.
         ...
         UsuarioRepositorio é uma classe do repositorio responsável por interagir com a camada de dados para
